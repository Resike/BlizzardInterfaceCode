function Localize()
	...
	DRIVER_BLACKLISTED = "<html><body><p align=\"CENTER\">Your device driver is not compatiple. Please see <a href=\"http://enGB.nydus.battle.net/WoW/enGB/launcher/driver-unsupported\">http://enGB.nydus.battle.net/WoW/enGB/launcher/driver-unsupported</a> for more information.</p></body></html>";
	DRIVER_OUTOFDATE = "<html><body><p align=\"CENTER\">Your device driver is out of date. Please see <a href=\"http://enGB.nydus.battle.net/WoW/enGB/launcher/driverupdates\">http://enGB.nydus.battle.net/WoW/enGB/launcher/driverupdates</a> for more information.</p></body></html>";
	DEVICE_BLACKLISTED = "<html><body><p align=\"CENTER\">Your video device is not compatiple. Please see <a href=\"http://enGB.nydus.battle.net/WoW/enGB/launcher/video-unsupported\">http://enGB.nydus.battle.net/WoW/enGB/launcher/video-unsupported</a> for more information.</p></body></html>";
	SYSTEM_INCOMPATIBLE_SSE = "<html><body><p align=\"CENTER\">This system will not be supported in future versions of World of Warcraft. Please see <a href=\"http://enGB.nydus.battle.net/WoW/enGB/launcher/sse1-unsupported\">http://enGB.nydus.battle.net/WoW/enGB/launcher/sse1-unsupported</a> for more information.</p></body></html>";
	FIXEDFUNCTION_UNSUPPORTED = "<html><body><p align=\"CENTER\">This video card will not be supported in future versions of World of Warcraft. Please see <a href=\"http://enGB.nydus.battle.net/WoW/enGB/launcher/fixedfunction-unsupported\">http://enGB.nydus.battle.net/WoW/enGB/launcher/fixedfunction-unsupported</a> for more information.</p></body></html>";
